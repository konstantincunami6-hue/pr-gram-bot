...
def handle_text(message):
    ...
    # Обработка кнопки ОП — теперь точно сработает
    if "ОП" in text and "Проверка" in text:
        op_text = """
...
@Tsunami_TG
    ...
    # Остальные кнопки (добавь сюда свои, если нужно)
...
print("Бот запущен — кнопка ОП теперь работает!")
